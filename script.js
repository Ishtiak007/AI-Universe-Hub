...
const showData = (data) => {
  ...
  data.tools.forEach((data) => {
    ...
    <div class="card-body items-left text-center">
      <h2 class="card-title text-xl mt-6">Features</h2>
      <div class="my-5 border-b-2 text-left">
        <div class="mb-5">
      ...
      <div class="text-left mt-4">
        ...
        <p class="flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
